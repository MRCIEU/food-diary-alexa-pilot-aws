// test intent handler based on https://github.com/alexa-samples/skill-sample-java-fact/blob/master/src/com/amazon/ask/airplanefacts/handlers/FactIntentHandler.java
...
public class FactIntentHandler implements RequestHandler {
    ...
    private static Logger logger = LoggerFactory.getLogger(FactIntentHandler.class);
    ...
    public Optional<Response> handle(HandlerInput input) {
    	...
    	logger.info("XXXXXXXXXXXXXXXXXXXXX FactIntentHandler.handle");
